...
HD_PWD='C:/Users/User/Desktop/Anstek Training/LAB2/Basys/Basys.runs/synth_19'
cd "$HD_PWD"
...
EAStep vivado -log seg_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_led.tcl

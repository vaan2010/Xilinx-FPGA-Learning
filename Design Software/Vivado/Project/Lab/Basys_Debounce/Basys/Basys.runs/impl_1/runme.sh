...
HD_PWD='C:/Users/User/Desktop/Anstek Training/LAB2/Basys/Basys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seg_led.tcl -notrace
